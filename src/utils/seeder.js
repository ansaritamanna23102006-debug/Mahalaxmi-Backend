...
const categoriesData = [
  ...
  },
  {
    ...
    image: "/images/Gajar (Carrot) Halwa.jfif"
  },
  {
  ...
  },
  {
    ...
    image: "/images/🌟 Samosa Chaat.jfif"
  },
  {
    ...
    image: "/images/The Jalebi Fafda.jfif"
  },
  {
    ...
    image: "/images/Dhokla ढोकळा.jfif"
  },
  {
    name: "Sweets",
...
const productsData = [
  ...
  // ─── MILK SWEETS ───
  {
    ...
    images: ["/images/malai barfi.jfif"],
    variants: [
  ...
  // ─── LADDU VARIETIES ───
  {
    ...
    images: ["/images/Motichoor Laddoo.jfif"],
    variants: [
  ...
  },
  {
    ...
    images: ["/images/Besan ladoo.jfif"],
    variants: [
      { weight: "100gm", price: 40, stock: 100 },
      { weight: "250gm", price: 100, stock: 100 },
      { weight: "500gm", price: 200, stock: 100 },
  ...
  },
  {
    ...
    images: ["/images/coconut laddu.jfif"],
    variants: [
      { weight: "100gm", price: 60, stock: 100 },
      { weight: "250gm", price: 150, stock: 100 },
      { weight: "500gm", price: 300, stock: 100 },
  ...
  // ─── HALWA & SPECIALS ───
  {
    ...
    images: ["/images/Lauki Halwa _ Dudhi ka Halwa.jfif"],
    variants: [
      { weight: "100gm", price: 40, stock: 100 },
      { weight: "250gm", price: 100, stock: 100 },
      { weight: "500gm", price: 200, stock: 100 },
  ...
  },
  {
    ...
    images: ["/images/Gajar (Carrot) Halwa.jfif"],
    variants: [
      { weight: "100gm", price: 60, stock: 100 },
      { weight: "250gm", price: 150, stock: 100 },
      { weight: "500gm", price: 300, stock: 100 },
  ...
  // ─── JAMUN VARIETIES ───
  {
    ...
    images: ["/images/Gulab Jamun.jfif"],
    variants: [
      { weight: "100gm", price: 40, stock: 100 },
      { weight: "250gm", price: 100, stock: 100 },
      { weight: "500gm", price: 200, stock: 100 },
  ...
  },
  {
    ...
    images: ["/images/malai jamun.jfif"],
    variants: [
      { weight: "100gm", price: 60, stock: 100 },
      { weight: "250gm", price: 150, stock: 100 },
      { weight: "500gm", price: 300, stock: 100 },
  ...
  },
  {
    ...
    images: ["/images/Kesharia Rajbhog.jfif"],
    variants: [
      { weight: "1 Piece", price: 25, stock: 100 },
      { weight: "5 Pieces", price: 125, stock: 100 },
      { weight: "12 Pieces", price: 300, stock: 100 }
  ...
  },
  {
    ...
    images: ["/images/Kheer Kadam.jfif"],
    variants: [
      { weight: "1 Piece", price: 25, stock: 100 },
      { weight: "5 Pieces", price: 125, stock: 100 },
      { weight: "12 Pieces", price: 300, stock: 100 }
  ...
  },
  {
    ...
    images: ["/images/Kesar Malai Sandwich.jfif"],
    variants: [
      { weight: "1 Piece", price: 50, stock: 100 },
      { weight: "5 Pieces", price: 250, stock: 100 },
      { weight: "10 Pieces", price: 500, stock: 100 }
  ...
  },
  {
    ...
    images: ["/images/Chum Chum Reci.jfif"],
    variants: [
      { weight: "1 Piece", price: 50, stock: 100 },
      { weight: "5 Pieces", price: 250, stock: 100 },
      { weight: "10 Pieces", price: 500, stock: 100 }
  ...
  },
  {
    ...
    images: ["/images/Bhajiya Pav,.jfif"],
    variants: [
      { weight: "1 Portion", price: 25, stock: 100 }
    ],
    stock: 100,
  ...
  // ─── NASTA MENU: BHAJIYA & PLATES ───
  {
    ...
    images: ["/images/Mixed variety bhajiya.jfif"],
    variants: [
  ...
  },
  {
    ...
    images: ["/images/Crispy Onion Bhaji.jfif"],
    variants: [
      { weight: "100gm", price: 40, stock: 100 },
      { weight: "250gm", price: 100, stock: 100 },
      { weight: "500gm", price: 200, stock: 100 },
  ...
  },
  {
    ...
    images: ["/images/🌟 Samosa Chaat.jfif"],
    variants: [
      { weight: "1 Plate", price: 50, stock: 100 }
    ],
    stock: 100,
  ...
  // ─── NASTA MENU: JALEBI & FAFDA SPECIALS ───
  {
    ...
    images: ["/images/The Jalebi Fafda.jfif"],
    variants: [
  ...
  // ─── NASTA MENU: GUJARATI SNACKS ───
  {
    ...
    images: ["/images/Dhokla ढोकळा.jfif"],
    variants: [
      { weight: "100gm", price: 40, stock: 100 },
      { weight: "250gm", price: 100, stock: 100 },
      { weight: "500gm", price: 200, stock: 100 },
  ...
  },
  {
    ...
    images: ["/images/mawa kachori.jfif"],
    variants: [
      { weight: "1 Piece", price: 50, stock: 100 }
    ],
    stock: 100,
  ...
  },
  {
    ...
    images: ["/images/mawa samosa.jfif"],
    variants: [
      { weight: "1 Piece", price: 50, stock: 100 }
    ],
    stock: 100,
